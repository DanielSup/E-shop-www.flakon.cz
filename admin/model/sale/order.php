...
class ModelSaleOrder extends Model {
	...
	public function getOrderProducts($order_id) {
		$query = $this->db->query("SELECT " . DB_PREFIX . "order_product.order_product_id, " . DB_PREFIX . "order_product.order_id, " . DB_PREFIX . "order_product.product_id, " . DB_PREFIX . "order_product.name, " . DB_PREFIX . "order_product.model, " . DB_PREFIX . "order_product.quantity, " . DB_PREFIX . "order_product.price, " . DB_PREFIX . "order_product.total, " . DB_PREFIX . "order_product.tax, " . DB_PREFIX . "order_product.reward, ". DB_PREFIX ."product. image "
                        . "FROM " . DB_PREFIX . "order_product, ". DB_PREFIX ."product WHERE order_id = '" . (int)$order_id . "' AND "
