...
class ControllerShippingSpeedy extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['Speedy_cost'])) {
			$this->data['Speedy_cost'] = $this->request->post['Speedy_cost'];
		} else {
			$this->data['Speedy_cost'] = $this->config->get('Speedy_cost');
		}

		if (isset($this->request->post['Speedy_tax_class_id'])) {
			$this->data['Speedy_tax_class_id'] = $this->request->post['Speedy_tax_class_id'];
		} else {
			$this->data['Speedy_tax_class_id'] = $this->config->get('Speedy_tax_class_id');
		}
