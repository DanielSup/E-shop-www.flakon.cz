...
class ControllerShippingColissimo extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['Colissimo_cost'])) {
			$this->data['Colissimo_cost'] = $this->request->post['Colissimo_cost'];
		} else {
			$this->data['Colissimo_cost'] = $this->config->get('Colissimo_cost');
		}
		...
		if (isset($this->request->post['Colissimo_geo_zone_id'])) {
			$this->data['Colissimo_geo_zone_id'] = $this->request->post['Colissimo_geo_zone_id'];
		} else {
			$this->data['Colissimo_geo_zone_id'] = $this->config->get('Colissimo_geo_zone_id');
		}
