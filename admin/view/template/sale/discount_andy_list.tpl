    ...
    <div class="content">
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            <?php if ($discounts_andy) { ?>
            <?php foreach ($discounts_andy as $discount_andy) { ?>
            <tr>
              <td style="text-align: center;"><?php if ($discount_andy['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $discount_andy['discount_andy_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $discount_andy['discount_andy_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $discount_andy['name']; ?></td>
              <td class="right"><?php echo $discount_andy['discount']; ?></td>
              <td class="left"><?php echo $discount_andy['date_start']; ?></td>
              <td class="left"><?php echo $discount_andy['date_end']; ?></td>
              <td class="left"><?php echo $discount_andy['status']; ?></td>
              <td class="right"><?php foreach ($discount_andy['action'] as $action) { ?>
