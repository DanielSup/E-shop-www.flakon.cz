...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  <?php if (strcmp($payment_method,$text_bank_transfer) == 0) { ?>
  <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_greeting; ?></p>
  <?php } else { ?>
  <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_greeting_nobt; ?></p>
  <?php } ?>
  <?php if ($customer_id) { ?>
    ...
    <tbody>
      <tr>
        ...
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_email; ?></b> <?php echo $email; ?><br />
          ...
          <?php echo "<a href=\"http://www.flakon.cz/viewOrder.php?order=$order_id\">http://www.flakon.cz/viewOrder.php?order=$order_id</a>"?>
        </td>
      </tr>
    </tbody>
  </table>
  <?php if (strcmp($payment_method,$text_bank_transfer) == 0) { ?>
  <table>
  <tr><td><?php echo $text_bank_account_number;?></td><td><strong>2700825950/2010</strong></td></tr>
  <tr><td><?php echo $text_variable_symbol;?></td><td><strong><?php echo $order_id; ?></strong></td></tr>
  </table>
  <?php }?>
  <?php if ($comment) { ?>
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
