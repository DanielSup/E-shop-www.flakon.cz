		...
		if ($order_info && !$order_info['order_status_id']) {
			...
			foreach ($order_product_query->rows as $order_product) {
				$this->db->query("UPDATE " . DB_PREFIX . "product SET quantity = (quantity - " . (int)$order_product['quantity'] . ") WHERE product_id = '" . (int)$order_product['product_id'] . "' AND subtract = '1'");
                                $this->db->query("UPDATE " . DB_PREFIX . "product SET status = '0' WHERE product_id = '" . (int)$order_product['product_id'] . "' AND quantity = '0' AND subtract = '1'");
			...
			$template->data['text_greeting_nobt'] = sprintf($language->get('text_new_greeting_nobt'), html_entity_decode($order_info['store_name'], ENT_QUOTES, 'UTF-8'));
			...
			$template->data['text_bank_transfer'] = $language->get('text_new_bank_transfer');
			$template->data['text_bank_account_number'] = $language->get('text_new_bank_account_number');
			$template->data['text_variable_symbol'] = $language->get('text_new_variable_symbol');
